...
const regions = [
  {
    ...
    enemies: [
      ...
      ["Starvent Crab","Cosmic Ventworks","Starforge Clawlord","Forge of Blue Fire"],
      ["Shardwake Eel","Shardwake Channels","Riftcoil Eel","Splintercurrent Ring"],
      ["Deep-Orbit Nautilus","Deep-Orbit Spiral","Starcoil Nautilus","Celestial Coil"],
      ...
      ["Fallen Star Walker","Celestial Ruin March","Firmament Warden","Temple of the Fallen Arc"],
      ...
      ["Celestial Corekeeper","The Buried Celestial Engine","Corewake Custodian","Engine of the Deep Sky"],
  ...
  },
  {
    ...
    enemies: [
      ...
      ["Veilmoss Grouper","The Vanishing Grove","Unseen Grovejaw","Mirror-Moss Hollow"],
      ["Shrinebark Guardian","Shrinebark Pilgrimage","First-Root Guardian","Old Bark Sanctuary"],
      ["Starmaw Blossom","Starflower Hunting Beds","Devouring Starflower","Pollenmoon Pit"],
      ["Dreamsap Leech","Dreamsap Pools","Nightmare Sapmother","Sleeping Rootwell"],
      ["Kelpweave Spider","Kelpweave Galleries","Moonloom Weaver","Tide-Silk Rotunda"],
  ...
  },
  {
    ...
    enemies: [
      ...
      ["Titanwake Drake","Titanwake Delta","Wakejaw Ancient","Flooded Fangbank"],
      ...
      ["Ancient Tooth Sentinel","The Fallen Fang","Primeval Fangkeeper","Fang of Ages"],
      ["Trench-Rending Worm","Riven Trench","Worldscar Worm","Split-Sea Chasm"],
      ["Songwake Phantom","The Last Leviathan Song","Primordial Voice","Resonance Grave"],
  ...
  },
  {
    ...
    enemies: [
      ...
      ["Gilded Platefin","Gilded Processional","Auric Platefish","Golden Review Court"],
      ...
      ["Tithekeeper Octopus","Taxkeeper Offices","Exchequer Krakenet","Treasury Reckoning"],
      ...
      ["Crown-Caged Chimera","The Ruined Menagerie","King's Chimera","Menagerie Crown Cage"],
      ...
      ["Royal Oath Construct","The Seven Royal Seals","Covenant Engine","Sealheart Chamber"],
  ...
  },
  {
    ...
    enemies: [
      ...
      ["Angleweave Eel","Impossible Angles","Fractured-Angle Coil","The Unclosed Triangle"],
      ...
      ["Mirror-Self Mimic","Hall of Other Selves","Unchosen Reflection","Mirror of Abandoned Paths"],
      ...
      ["Convergence Elemental","Convergent Currents","Sixfold Tideheart","Confluence Core"],
      ...
      ["Fae Stoneweaver","The Unbuilding Ruins","Last Architect Construct","Blueprint of Vanishing Stone"],
      ["Eventide Behemoth","Eventide Threshold","Endless Dusk Behemoth","Boundary Without Dawn"],
      ["Portalgrave Prowler","Portal Graveyard","Dead-Gate Collector","Sepulcher of Exits"],
...
const stableRenamedIds = {
  "Starvent Crab": "cosmic-vent-crab",
  "Starforge Clawlord": "superheated-ventlord",
  "Starcoil Nautilus": "periapsis-nautilus",
  "Fallen Star Walker": "celestial-ruin-walker",
  "Celestial Corekeeper": "celestial-core-keeper",
  "Veilmoss Grouper": "camouflage-grouper",
  "Starmaw Blossom": "predatory-starflower",
  "Moonloom Weaver": "grand-loom-spider",
  "Titanwake Drake": "titanwake-crocodile",
  "Primeval Fangkeeper": "first-tooth-sentinel",
  "Songwake Phantom": "leviathan-song-echo",
  "Gilded Platefin": "gilded-armorfish",
  "Tithekeeper Octopus": "taxkeeper-octopus",
  "Crown-Caged Chimera": "royal-menagerie-beast",
  "Royal Oath Construct": "royal-seal-construct",
  "Angleweave Eel": "geometry-eel",
  "Fractured-Angle Coil": "euclidean-coilbreaker",
  "Mirror-Self Mimic": "echo-of-self-mimic",
  "Convergence Elemental": "nexus-current-elemental",
  "Fae Stoneweaver": "fae-ruin-architect",
  "Portalgrave Prowler": "portal-grave-scavenger",
};
...
for (const region of regions) {
  ...
  region.enemies.forEach(([enemyName, adventureName, bossName, chamber], i) => {
    const number = i + 1;
    const enemyId = stableRenamedIds[enemyName] || slug(enemyName);
    const bossId = `${stableRenamedIds[bossName] || slug(bossName)}-boss`;
